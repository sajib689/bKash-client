  ...
  return (
    <div>
      <h1 className="pt-12 text-4xl ms-2">
        ...
        <input required name="name" type="text" className="grow" placeholder="Enter your name" />
      </label>
      <label className="m-3 input input-bordered flex items-center gap-2">
        <input required name="number" type="number" className="grow" placeholder="Enter your number" />
      </label>
      <label className="m-3 input input-bordered flex items-center gap-2">
        <svg
        ...
        <input required name="email" type="text" className="grow" placeholder="Enter your Email" />
      </label>
